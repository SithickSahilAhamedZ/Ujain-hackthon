...
const SidebarContent: React.FC<{
  ...
  userRole: 'user' | 'admin' | null;
  onLogout: () => void;
}> = ({ activePage, setActivePage, onLinkClick, userRole, onLogout }) => {
  const { t } = useI18n();
...
const Sidebar: React.FC<SidebarProps> = ({ activePage, setActivePage, isMenuOpen, setMenuOpen, userRole, onLogout }) => {
